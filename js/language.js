...
function showContent() {
    ...
    if (lang === "en") {
        ...
        if (lang === "ja") {
            ...
            document.getElementById("aboutme").innerHTML = "나는 <strong id='usernameid'>KC(KirisameCirno)</strong>라고 해.<br>나는 음악, 게임 그리고 애니메이션과 관련된 모든 것을 좋아해.<br>온갖 종류의 음식과 음료를 좋아하며, 특히 대만의 차를 좋아해.<br>일본에선 2급 아마추어 무선통신 자격증을 대만에선 3급 아마추어 무선통신 자격증을 가지고 있어.<br>나는 여러 가지 악기를 연주할 수 있어, 주로 피아노와 아코디언을 하고, 연주할 수 있어.<br>오버톤 창법도 어느 정도 할 수 있어.<br>방문해줘서 고마워.";
