...
function showContent() {
    ...
    if (lang === "ja") {
        ...
        document.getElementById("robloxGameLink").innerHTML = "<a href='https://www.roblox.com/games/17202293479/Teahouse-Umigiri-A-Tea-making-simulator' style='color:blue'><s>私のゲーム</s></a> <span style='color: black;'>糞ゲーRobloxがチャット機能を殺したのでこのゲームはもう意味がない</span>";
    } else if (lang === "zh") {
        ...
        document.getElementById("robloxGameLink").innerHTML = "<a href='https://www.roblox.com/games/17202293479/Teahouse-Umigiri-A-Tea-making-simulator' style='color:blue'><s>我的遊戲</s></a> <span style='color: black;'>他媽的Roblox毀了聊天功能所以這遊戲現在沒有屁用了</span>";
    } else if (lang === "tw") {
        ...
        document.getElementById("robloxGameLink").innerHTML = "<a href='https://www.roblox.com/games/17202293479/Teahouse-Umigiri-A-Tea-making-simulator' style='color:blue'><s>我的遊戲</s></a> <span style='color: black;'>幹林娘Roblox殺了聊天功能所以這遊戲沒有意義了</span>";
    }
}
