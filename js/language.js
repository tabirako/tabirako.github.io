...
function showContent() {
    ...
    if (lang === "ja") {
        ...
        document.getElementById("aboutme").innerHTML = "私は<strong id='usernameid'>KC(KirisameCirno)</strong>と申します。<br>普段は<strong>(KC)</strong>でいいです。<br>音楽全般、ゲームとアニメ関係のが好きです。<br>色んな料理と飲み物、特に台湾茶が好きです。アマチュア無線を扱っている人（第二級アマチュア無線技士+台湾三等業餘無線電人員)<br>ピアノ、アコーディオンとフルート奏者であります。喉歌もできるです<br>ご覧いただきありがとうございます！";
        ...
        document.getElementById("aboutme").innerHTML = "我叫做<strong id='usernameid'>KC(KirisameCirno)</strong><br>平常叫<strong>(KC)</strong>就好。<br>興趣是音樂、遊戲、動畫和漫畫。<br>喜歡各種料理和飲料﹐尤其是台灣茶。同時是業餘無線電操作者（現在是台灣三等業餘無線電人員+日本第二級アマチュア無線技士）<br>能夠彈奏鋼琴、手風琴和一點點的長笛﹐還會一些呼麥<br>感謝您的來訪！";
